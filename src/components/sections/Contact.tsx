                ...
                <div className="glass-panel p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="name"
                                       className="block font-work text-sm font-medium text-foreground mb-2">
                                    Name *
                                </label>
                                <Input
                                    id="name"
                            ...
                            {contactInfo.map((info, index) => {
                                ...
                                return (
                                    <div key={index} className="flex items-start">
                                        <div
                                            className="inline-flex items-center justify-center w-10 h-10 bg-primary/20 rounded-lg mr-4 flex-shrink-0 mt-1">
